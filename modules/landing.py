...
def _onboarding():
    ...
    cards = [
        {"icon":"🎧","en":"Welcome to ShadowingLab","zh":"欢迎使用 ShadowingLab","detail_en":"Shadowing — repeating speech as you hear it — is one of the most research-supported methods for developing both listening and speaking skills in a second language.\n\nShadowingLab guides you through structured shadowing practice designed to sharpen how you hear English and how clearly you speak it.\n\nOne thing to keep in mind: the goal is not a perfect accent. It's confident, intelligible speech. Your accent is part of who you are — we're here to help you be understood.","detail_zh":"跟读法——即在听到语音的同时重复——是第二语言习得研究中最具实证支持的方法之一，能同时提升听力和口语能力。\n\nShadowingLab 为你提供结构化的跟读练习，帮助你更清晰地听懂英语、更清楚地表达自己。\n\n请记住：我们的目标不是完美的口音，而是自信、清晰、易于理解的英语表达。你的口音是你的一部分——我们在这里帮助你让别人听懂你。","btn":"Tell me more / 继续"},
